...
const expense = store.dispatch(addExpense({description: 'rent', amount: 100, createdAt: -1000}));
const expense2 = store.dispatch(addExpense({description: 'coffee', amount: 500, createdAt: -21000}));
